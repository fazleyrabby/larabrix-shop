    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="row row-deck row-cards">
                <div class="col-12">
                    <form class="card" action="{{ route('admin.blogs.update', $blog->id) }}" method="post">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col">
                                    <input type="text" class="form-control"
                                        placeholder="slug" name="slug" value="{{ $blog->slug }}">
                                    <small class="form-hint">
                                        @error('slug')
                                            <div class="text-danger mt-2">{{ $message }}</div>
                                        @enderror
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col">
                                    <textarea id="hugerte-mytextarea" name="body">{{ $blog->body }}</textarea>
                                    <small class="form-hint">
                                        @error('body')
                                            <div class="text-danger mt-2">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col">
                                    <select name="tags[]" id="tags" multiple class="form-control">
                                        @foreach ($tags as $id => $tag)
                                            <option value="{{ $id }}" @selected(in_array($id, old('tags', $blog->tags->pluck('id')->toArray() ?? [])))>
                                                {{ $tag }}
                                            </option>
                                        @endforeach
                                    </select>
