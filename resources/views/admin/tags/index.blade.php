        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('admin.tags.create', ['type' => request()->get('type')]) }}" class="btn btn-primary">
                  ...
                  <div class="d-flex">
                    <div class="text-secondary">
                      ...
                      <div class="mx-2 d-inline-block">
                        <select name="limit" onchange="updateData(this)" data-route="{{ route('admin.tags.index') }}">
                        ...
                        <td class="text-end">
                          <span class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                              <a class="dropdown-item" href="{{ route('admin.tags.edit', ['type' => $type, 'tag' => $tag->id]) }}">
                                  Edit
                              </a>
                              <form onsubmit="return confirmDelete(event, this)"
                                  action="{{ route('admin.tags.destroy', ['tag' => $tag->id, 'type' => $type]) }}"
                                  method="post">
                                  @csrf
                                  @method('delete')
