                                    ...
                                    @foreach ($attribute->values as $value)
                                        <div class="row attribute-value-row">
                                            <div class="col-md-5 mb-3">
                                                <input type="text" name="values[{{ $value->id }}][title]" class="form-control" placeholder="Company"
                                                    value="{{ $value->title }}">
                                            </div>
                                            <div class="col-md-5">
                                                <input type="text" name="values[{{ $value->id }}][slug]" class="form-control" placeholder="Company"
                                                    value="{{ $value->slug }}">
                                            </div>
