        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('admin.invoice', $order->id) }}" class="btn btn-primary">Invoice</a>
                        ...
                        <div class="card-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="badge {{ $order->status->value === 'pending' ? 'bg-yellow text-yellow-fg' : 'bg-blue text-blue-fg' }}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="badge {{ $order->payment_status === 'pending' ? 'bg-yellow text-yellow-fg' : 'bg-blue text-blue-fg' }}">
