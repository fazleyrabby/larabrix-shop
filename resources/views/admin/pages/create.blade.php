...
@section('content')
    ...
    <div class="page-body">
        <form action="{{ route('admin.pages.store') }}" id="pageForm" method="post" enctype="multipart/form-data">
            @csrf
            <div class="container-xl">
                <div class="row">
                    <div class="col-8">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <label class="form-check form-switch form-switch-3">
                                            <input class="form-check-input" type="checkbox" name="has_page_builder" checked="">
                                            <span class="form-check-label">Page Builder</span>
                                        </label>
                                    </div>
                                    <div class="card-footer">
                                        <button type="submit" class="btn btn-primary">Submit</button>
                                        <button type="submit" name="save" value="save" class="btn btn-success">Save & Edit</button>
                                    </div>
                                </div>
                            </div>
                        </div>
