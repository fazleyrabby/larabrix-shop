            ...
            <div class="col-12">
              <div class="card">
                  ...
                  <div class="d-flex">
                    <div class="text-secondary">
                      ...
                      <div class="mx-2 d-inline-block">
                        <select name="limit" onchange="updateData(this)" data-route="{{ route('admin.cruds.index') }}">
                    ...
                    <div class="ms-auto text-secondary">
                      ...
                      <div class="ms-2 d-inline-block">
                        <form action="">
                          <input type="text" class="form-control form-control-sm" aria-label="Search cruds" name="q" value="{{ request()->q }}">
                ...
                <div class="card-footer">
                  {{ $cruds->links('pagination::bootstrap-5') }}
                </div>
              </div>
            </div>
          </div>
