                        ...
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <div class="ms-auto lh-1">
                                        <div class="dropdown">
                                            <a class="dropdown-toggle text-secondary" href="#"
                                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Last 30
                                                days</a>
                                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <div class="d-flex align-items-baseline">
                                    <div class="h1 mb-0 me-2">{{ $count }}</div>
                                    <div class="me-auto">
                                        <span class="text-green d-inline-flex align-items-center lh-1">
                                            8%
                            ...
                            <div id="chart-{{ Str::slug($label) }}-bg" class="chart-sm"></div>
                        </div>
                    </div>
                @endforeach
                {{-- <div class="col-sm-6 col-lg-3">
