              ...
              <div class="card">
                  ...
                  <div class="d-flex">
                    <div class="text-secondary">
                      ...
                      <div class="mx-2 d-inline-block">
                        <select name="limit" onchange="updateData(this)" data-route="{{ route('admin.forms.index') }}">
                    ...
                    <div class="ms-auto text-secondary">
                      ...
                      <div class="ms-2 d-inline-block">
                        <form action="">
                          <input type="text" class="form-control form-control-sm" aria-label="Search Forms" name="q" value="{{ request()->q }}">
                ...
                <div class="table-responsive">
                  <table class="table card-table table-vcenter text-nowrap datatable">
                    ...
                    <tr>
                        <td><input class="form-check-input m-0 align-middle selected-item" type="checkbox" value="{{ $form->id }}" aria-label="Select invoice"></td>
                        <td><span class="text-secondary">{{ $form->id }}</span></td>
                        <td><a href="{{ route('admin.forms.show', $form->id) }}" class="text-reset" tabindex="-1">{{ $form->name }}</a></td>
